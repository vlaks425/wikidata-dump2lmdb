...
python3 preprocess_dump.py --input_file '/raid/lyu/deep/tools/sling/local/data/corpora/wikidata/wikidata-latest-all.json.bz2' --out_dir '/raid_elmo/home/lr/lyu/wikidata_processed/de' --num_lines_in_dump 96980335 --language_id de
...
def get_arg_parser():
    ...
    parser.add_argument('--input_file', type=str, required=True,
                        help='path to gz wikidata json dump')
    parser.add_argument('--out_dir', type=str, required=True,
                        help='path to output directory')
    parser.add_argument('--language_id', type=str,
                        default='en', help='language identifier')
    parser.add_argument('--processes', type=int, default=28,
                        help="number of concurrent processes to spin off. ")
    ...
    parser.add_argument('--num_lines_in_dump', type=int, default=9698035,
...
def main():
    ...
    print(
        f"Finished processing {num_lines_read.value} in {time.time() - start}s")
